...
class TimetableLocalizationsDelegate extends LocalizationsDelegate<TimetableLocalizations> {
...
extension BuildContextTimetableLocalizations on BuildContext {
  TimetableLocalizations get timetableLocalizations => TimetableLocalizations.of(this);
...
class TimetableLocalizationDe extends TimetableLocalizations {
  ...
  @override
  String weekOfYear(Week week) => 'Kalenderwoche ${week.weekOfYear}, ${week.weekBasedYear}';
}
...
class TimetableLocalizationEn extends TimetableLocalizations {
  ...
  @override
  String weekOfYear(Week week) => 'Week ${week.weekOfYear}, ${week.weekBasedYear}';
}
...
class TimetableLocalizationEs extends TimetableLocalizations {
  ...
  @override
  String weekOfYear(Week week) => 'Semana ${week.weekOfYear}, ${week.weekBasedYear}';
}
...
class TimetableLocalizationFr extends TimetableLocalizations {
  ...
  @override
  String weekOfYear(Week week) => 'Semaine ${week.weekOfYear}, ${week.weekBasedYear}';
}
...
class TimetableLocalizationHu extends TimetableLocalizations {
  ...
  @override
  List<String> weekLabels(Week week) => [weekOfYear(week), '${week.weekOfYear}. hét', '${week.weekOfYear}'];

  @override
  String weekOfYear(Week week) => '${week.weekOfYear}. hét, ${week.weekBasedYear}';
}
...
class TimetableLocalizationIt extends TimetableLocalizations {
  ...
  @override
  String weekOfYear(Week week) => 'Settimana ${week.weekOfYear}, ${week.weekBasedYear}';
}
