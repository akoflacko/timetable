...
abstract class VisibleDateRange with Diagnosticable {
  ...
  factory VisibleDateRange.fixed(DateTime startDate, int visibleDayCount) => FixedDaysVisibleDateRange(startDate, visibleDayCount);
...
class DaysVisibleDateRange extends VisibleDateRange {
  DaysVisibleDateRange(
    ...
    maxPage = maxDate == null ? null : _getMinimumPageForFocus(maxDate!.page).coerceAtLeast(minPage ?? double.negativeInfinity);
  }
  ...
  double getTargetPageForFocus(
    ...
    final alignmentDifference = (targetFocusPage.floor() - alignmentDate.datePage) % swipeRange;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DateDiagnosticsProperty('minDate', minDate, defaultValue: null));
    properties.add(DoubleProperty('minPage', minPage, defaultValue: null));
    properties.add(DateDiagnosticsProperty('maxDate', maxDate, defaultValue: null));
