...
class TimeRange {
  ...
  bool contains(TimeRange other) => startTime <= other.startTime && other.endTime <= endTime;
  ...
  bool operator ==(Object other) {
    return other is TimeRange && startTime == other.startTime && endTime == other.endTime;
  }
