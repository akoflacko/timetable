            ...
            ((context, week) {
              ...
              return WeekIndicator(
                ...
                style: (style ?? timetableTheme.monthWidgetStyleProvider(month)).removeIndividualWeekDecorations
                    ? timetableTheme.weekIndicatorStyleProvider(week).copyWith(decoration: const BoxDecoration())
                    : null,
      ...
      children: [
        ...
        for (final day in 1.rangeTo(DateTime.daysPerWeek))
          GridPlacement(
            ...
            rowStart: 0,
            child: Center(
              child: weekDayBuilder(context, today + (day - today.weekday).days),
            ),
          ),
        GridPlacement(
          columnStart: 0,
...
class MonthWidgetStyle {
  factory MonthWidgetStyle(
    ...
    return MonthWidgetStyle.raw(
      ...
      showDatesFromOtherMonthsAsDisabled: showDatesFromOtherMonthsAsDisabled ?? true,
    );
  }
  ...
  MonthWidgetStyle copyWith({
    ...
    return MonthWidgetStyle.raw(
      ...
      removeIndividualWeekDecorations: removeIndividualWeekDecorations ?? this.removeIndividualWeekDecorations,
      datePadding: datePadding ?? this.datePadding,
      showDatesFromOtherMonths: showDatesFromOtherMonths ?? this.showDatesFromOtherMonths,
      showDatesFromOtherMonthsAsDisabled: showDatesFromOtherMonthsAsDisabled ?? this.showDatesFromOtherMonthsAsDisabled,
    );
  }
  ...
  bool operator ==(Object other) {
    return other is MonthWidgetStyle &&
        ...
        removeIndividualWeekDecorations == other.removeIndividualWeekDecorations &&
        datePadding == other.datePadding &&
        showDatesFromOtherMonths == other.showDatesFromOtherMonths &&
        showDatesFromOtherMonthsAsDisabled == other.showDatesFromOtherMonthsAsDisabled;
  }
}
