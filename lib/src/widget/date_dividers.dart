...
class DateDividers extends StatelessWidget {
  ...
  Widget build(BuildContext context) => CustomPaint(
        painter: _DateDividersPainter(
          ...
          style: style ?? TimetableThemeScope.maybeOrDefaultOf(context).dateDividersStyle,
        ),
        child: child,
      );
}
...
class DateDividersStyle {
  ...
  bool operator ==(Object other) {
    return other is DateDividersStyle && color == other.color && width == other.width;
  }
}
...
class _DateDividersPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_DateDividersPainter oldDelegate) => style != oldDelegate.style;
}
