...
class MultiDateContentGeometry extends State<_MultiDateContentGeometryWidget> {
  ...
  static MultiDateContentGeometry? maybeOf(BuildContext context) => context.findAncestorStateOfType();
}
...
class PartDayDraggableEvent extends StatefulWidget {
  ...
  PartDayDraggableEvent.forGeometryKeys(
    ...
    Widget? childWhileDragging,
        ...
        onDragCanceled = onDragCanceled == null ? null : ((geometryKey, wasMoved) => onDragCanceled(geometryKey!, wasMoved)),
        childWhileDragging = childWhileDragging ?? _buildDefaultChildWhileDragging(child);
